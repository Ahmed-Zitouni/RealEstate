    ...
    Homes: [
      {
        ...
        appliances:
          "Dishwasher, Dryer, Freezer, Garbage disposal, Range / Oven, Refrigerator, Washer",
      ...
      },
      {
        ...
        images: [
          ...
          `https://maps.googleapis.com/maps/api/streetview?size=400x250&location=37.80304,-122.42422&fov=80&heading=70&pitch=0&key=AIzaSyDcXNX_SoIFTdYVs0QPk8e9ST6e9YwwN2c`
        ],
        desc: "No description provided",
        parkingType: "On-street",
        yearBuilt: "Unknown",
      ...
      },
      {
        ...
        images: [
          ...
          `https://maps.googleapis.com/maps/api/streetview?size=400x250&location=37.80271,-122.430168&fov=80&heading=70&pitch=0&key=AIzaSyDcXNX_SoIFTdYVs0QPk8e9ST6e9YwwN2c`
        ],
        desc: "No description provided",
        parkingType: "On-street",
        yearBuilt: "1924",
        ...
        appliances:
          "Garbage disposal, Microwave, Range / Oven, Refrigerator, Washer, Dishwasher, Freezer",
        floorCovering: "Hardwood",
      ...
      },
      {
        ...
        images: [
          ...
          `https://maps.googleapis.com/maps/api/streetview?size=400x250&location=37.791013,-122.407696&fov=80&heading=70&pitch=0&key=AIzaSyDcXNX_SoIFTdYVs0QPk8e9ST6e9YwwN2c`
        ],
        desc: "No description provided",
        ...
        coolingSystem: "None",
        appliances:
          "Microwave, Range / Oven, Refrigerator, Washer, Dishwasher, Dryer",
        rooms: "Laundry room"
      },
      {
        city: "San Francisco",
      ...
      },
      {
        ...
        coolingSystem: "None",
        appliances:
          "Dishwasher, Freezer, Garbage disposal, Microwave, Range / Oven, Refrigerator",
        floorCovering: "Hardwood",
      ...
      },
      {
        ...
        coolingSystem: "None",
        appliances:
          "Dishwasher, Dryer, Microwave, Range / Oven, Refrigerator, Washer, Freezer, Garbage disposal",
        floorCovering: "Hardwood, Tile",
